...
namespace projectuni1
{
    public partial class LoginTeacher : Form
    {
        ...
        {
            if (txtTeacherId.Text.Trim() == string.Empty && txtPassword.Text.Trim() == string.Empty)
            {
            ...
            else
            {
                ...
                str = "Select * from teacher where teacher_id='" + Convert.ToInt32(txtTeacherId.Text) + "' and password='" + txtPassword.Text.ToString() + "'";
