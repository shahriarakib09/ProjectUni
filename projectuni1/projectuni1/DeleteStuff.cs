...
{
    public partial class DeleteStuff : UserControl
    {
        ...
        private static DeleteStuff _Instance;

        public static DeleteStuff instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new DeleteStuff();
                return _Instance;
            }
        }
        public DeleteStuff()
        ...
        {
            if (txtStuffDeleteId.Text.Trim() == string.Empty)
            {
            ...
            else
            {
                ...
                str = "Delete from stuff where stuff_id='" + Convert.ToInt32(txtStuffDeleteId.Text) + "'";
        ...
        private void txtStuffDeleteId_KeyPress(object sender, KeyPressEventArgs e)
        {
